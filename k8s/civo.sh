...
show_access_info() {
    ...
    echo " Frontend:     http://abhi07.xyz"
    echo " API:          http://api.abhi07.xyz"
    echo " Grafana:      http://grafana.abhi07.xyz"
    echo " Prometheus:   http://prometheus.abhi07.xyz"
    echo " Loki:         http://loki.abhi07.xyz"
    echo " ArgoCD:       http://argocd.abhi07.xyz"
    echo ""
    print_warning "Note: Replace 'abhi07.xyz' with your actual domain or use:"
    ...
    echo " URL:          http://argocd.abhi07.xyz"
    echo " Username:     admin"
